...
const ar = {
  ...
  report: {
    ...
    location: {
      ...
      tapToChange: 'اضغط على الخريطة لتغيير موقع الحادثة',
      editHint: 'اضغط على الخريطة لتحديد الموقع بدقّة',
      done: 'تم',
    },
    submit: 'إرسال البلاغ',
  ...
  feed: {
    ...
    allLocalities: 'كل البلدات',
    chooseCity: 'اختر البلدة',
    chooseType: 'نوع البلاغ',
    allTypes: 'كل الأنواع',
    resolved: 'منتهي',
  ...
  victims: {
    ...
    victimsLabel: 'الضحايا',
    total: 'إجمالي الضحايا',
    rangeTitle: 'فترة مخصصة',
    fromYear: 'من سنة',
    toYear: 'إلى سنة',
    inRange: 'ضحايا في الفترة المحددة',
    apply: 'تطبيق',
    memorialLabel: 'موقع تخليد الضحايا',
    memorialDesc: 'موقع لتخليد الضحايا في المجتمع العربي',
...
const he: typeof ar = {
  ...
  report: {
    ...
    location: {
      ...
      tapToChange: 'הקש על המפה לשינוי מיקום האירוע',
      editHint: 'הקש על המפה לקביעת המיקום המדויק',
      done: 'סיום',
    },
    submit: 'שלח דיווח',
    submitting: 'שולח...',
  ...
  feed: {
    ...
    ranges: {
      ...
      week: 'השבוע האחרון',
      month: 'החודש האחרון',
      quarter: '3 החודשים האחרונים',
      year: 'השנה האחרונה',
    },
    moreFilters: 'עוד',
    filtersTitle: 'מסננים נוספים',
    ...
    allLocalities: 'כל היישובים',
    chooseCity: 'בחר יישוב',
    chooseType: 'סוג הדיווח',
    allTypes: 'כל הסוגים',
    resolved: 'הסתיים',
  ...
  victims: {
    title: 'נתוני נפגעים בחברה הערבית',
    victimsLabel: 'נפגעים',
    total: 'סך כל הנפגעים',
    rangeTitle: 'טווח מותאם',
    fromYear: 'משנה',
    toYear: 'עד שנה',
    inRange: 'נפגעים בטווח שנבחר',
    apply: 'החל',
    memorialLabel: 'אתר הנצחת הנפגעים',
    memorialDesc: 'אתר להנצחת נפגעים בחברה הערבית',
...
const en: typeof ar = {
  ...
  report: {
    ...
    location: {
      ...
      tapToChange: 'Tap the map to change the incident location',
      editHint: 'Tap the map to set the exact location',
      done: 'Done',
    },
  ...
  victims: {
    title: 'Arab Community Victims Statistics',
    victimsLabel: 'Victims',
    total: 'Total Victims',
    rangeTitle: 'Custom range',
    fromYear: 'From year',
    toYear: 'To year',
    inRange: 'Victims in selected range',
    apply: 'Apply',
    memorialLabel: 'Visit Memorial Website',
    memorialDesc: 'Dedicated to commemorating victims in the Arab community',
