...
let _incidents: Incident[] = [
  {
    ...
    category: 'SUSPICIOUS',
    severity: 'medium',
    description: 'نشاط مشبوه قرب المدرسة',
    lat: 32.5145,
    lng: 35.1570,
  ...
  },
  {
    ...
    category: 'ASSAULT',
    severity: 'high',
    description: 'اعتداء في المنطقة التجارية',
    lat: 32.5130,
    lng: 35.1550,
    localityId: 'umm-al-fahm',
...
let _notifications: AppNotification[] = [
  {
    ...
    type: 'nearby',
    title: 'حادثة قريبة',
    body: 'تم الإبلاغ عن نشاط مشبوه على بعد 500 متر منك',
...
let _comments: Comment[] = [
  {
    ...
    incidentId: '1',
    identityTag: ['🦁', '🌙', '🎯'],
    body: 'رأيت سيارة بيضاء تدور في المنطقة',
