...
type Props = NativeStackScreenProps<RootStackParamList, 'CrisisSuccess'>;

export default function CrisisSuccessScreen({ navigation, route }: Props): React.ReactElement {
  ...
  return (
    <SafeAreaView style={styles.root} edges={['top', 'bottom']}>
      ...
      <View style={styles.content}>
        ...
        <Text variant="heading" style={styles.title}>{s.crisis.successTitle}</Text>
        <Text secondary style={styles.subtitle}>{s.crisis.successSubtitle}</Text>
