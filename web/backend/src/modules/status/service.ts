// Ported from mobile/backend/src/modules/status/service.ts — keep in sync.
// The operator dashboard calls GET /status?lat&lng without device side effects.
...
export async function getStatus(lat: number, lng: number): Promise<StatusResponse> {
